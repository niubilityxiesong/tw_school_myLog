...
const hoverContent = (
    <div>
        <div>暂无最新消息</div>
        <hr />
        <span><a float="right" href="url">全部消息</a></span>
    </div> 
);
...
class MyLogPanel extends Component{
    ...
    render(){
        return (
        <Layout>
            <Header className="header" style={{ lineHeight: '36px' }}>
            <Row style={{float:"bottom"}}>
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <div>
                <img src="../resources/logo.png" class="App-logo" alt="logo" style={{ height: '30px' }}></img>
                </div>
                </Col>
